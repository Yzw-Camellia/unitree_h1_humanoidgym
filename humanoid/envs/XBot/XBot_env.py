...
class XBotv1FreeEnv(LeggedRobot):
    '''
    ...
    def _get_gait_phase(self):
        ...
        # left foot stance[1 0]
        stance_mask[:, 0] = sin_pos >= 0
        # right foot stance[0 1]
        stance_mask[:, 1] = sin_pos < 0
        # Double support phase[1 1]
    ...
    def compute_ref_state(self):
        ...
        scale_1 = 0.90#self.cfg.rewards.target_joint_pos_scale
        scale_2 = 0.40#2 * scale_1
        scale_3 = 0.20
